...
## Исходный файл набора данных

В проекте используется реальный датасет:

**EuroCrop_agricultural_logistics_dataset.csv**

Этот файл является основной базой данных исследования.  
Он содержит табличные наблюдения, связанные с аграрной транспортной логистикой, параметрами перевозок, характеристиками культур, временными задержками и целевой колонкой `Spoilage_Risk`.

Данный датасет является исходной точкой для полного анализа и построения моделей. На его основе выполнялись:

- предварительное исследование данных (EDA)
- обработка данных и создание новых признаков (Feature Engineering)
- кодирование категориальных признаков
- нормализация и масштабирование данных
- обучение моделей XGBoost и Random Forest в качестве baseline
- обучение итоговой рекуррентной модели LSTM для моделирования временной динамики и предсказания риска порчи
